...
REPO = ENV.fetch("GITHUB_REPOSITORY", "jaxassistant55/content-repurposing-sprint-starter")
OFFER_TITLE = "Content Repurposing Sprint Starter"
PRICE = "$100"
OFFER_PAGE = "https://jaxassistant55.github.io/jax-micro-offer-studio/content-repurposing-sprint.html"
READY_FORM = "https://github.com/jaxassistant55/content-repurposing-sprint-starter/issues/new?template=ready-to-pay-content-repurposing-sprint-starter.yml"
ORDER_BOARD = "https://github.com/jaxassistant55/content-repurposing-sprint-starter/issues/1"
...
ONE_SALE_PAYMENT_PACKET = "https://jaxassistant55.github.io/jax-micro-offer-studio/one-sale-payment-packets.html#central-content-repurposing-sprint"
ONE_SALE_PAYMENT_PACKET_ID = "OSP-20260616-21-CONTENT-REPURPOSING-SPRINT"
ONE_SALE_PAYMENT_PACKET_INVOICE_LINE = "Content Repurposing Sprint fixed-scope service - $100 - accepted scope or product transfer per https://jaxassistant55.github.io/jax-micro-offer-studio/content-repurposing-sprint.html"
PAYMENT_HANDOFF = "https://jaxassistant55.github.io/jax-micro-offer-studio/standalone-payment-handoff.html#content-repurposing-sprint-starter"
...
TERMS_URL = "https://jaxassistant55.github.io/jax-micro-offer-studio/standalone-offer-terms.html#content-repurposing-sprint-starter"
EXACT_ACCEPTANCE = "I accept the Content Repurposing Sprint Starter fixed-scope work terms at $100. I understand work or transfer starts only after seller-owned external payment proof exists; I will provide only public or buyer-owned/buyer-authorized non-sensitive inputs; the deliverable is limited to the public preview, README/ORDER scope, and accepted ready-to-pay form details; and credentials, account login work, unauthorized private files, confidential regulated data handling, purchasing, publishing changes, ongoing support, custom implementation beyond the accepted scope, or extra revisions are not included unless separately agreed before payment."
